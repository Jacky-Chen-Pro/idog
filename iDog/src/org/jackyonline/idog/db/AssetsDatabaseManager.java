...
public class AssetsDatabaseManager {  
    ...
    private static String databasepath = Constants.DATA_PATH; // org.jackyonline.listtest is packageName  
    ...
    public SQLiteDatabase getDatabase(String dbfile) {  
        if(databases.get(dbfile) != null){  
            Log.i(tag, String.format("Return a database copy of org.jackyonline.idog", dbfile));  
            return (SQLiteDatabase) databases.get(dbfile);  
        }  
        if(context==null)  
            return null;  
          
        Log.i(tag, String.format("Create database org.jackyonline.idog", dbfile));  
